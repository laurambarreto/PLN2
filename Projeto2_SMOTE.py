...
X_train_res, y_train_res = smote.fit_resample(X_train_num, y_train_num)

# Contagem de amostras por classe nos dados de treino após SMOTE
print(f"\nDados de treino após SMOTE:", pd.Series(y_train_res).value_counts())
